        ...
        <div class="col-md-4 products-left">
          <div class="categories">
            ...
            <ul class="cate">
              <li>
                <a href="/category">
                  <i class="fa fa-arrow-right" aria-hidden="true"></i>Fruits And
                  Vegetables
                </a>
              </li>
              <ul>
                ...
                <li>
                  <a href="/category">
                    <i class="fa fa-arrow-right" aria-hidden="true"></i>Flowers
                  </a>
                </li>
                <li>
                  <a href="/category">
              ...
              <ul>
                ...
                <li>
                  <a href="/category">
                    <i class="fa fa-arrow-right" aria-hidden="true"></i>Sanitary
                    Needs
                  </a>{" "}
                </li>
                <li>
                ...
                <li>
                  <a href="/category">
                    <i class="fa fa-arrow-right" aria-hidden="true"></i>Personal
                    Hygiene
                  </a>{" "}
                </li>
                <li>
